...
function DetailedMenItem() {
  ...
  return (
    <div className="bg-gradient-to-b from-pink-100 via-pink-200 to-pink-100 pt-20">
          ...
          <div className="flex items-center justify-center gap-2">
            {isInCart && (
              <button
                ...
                className="font-medium border rounded-full bg-pink-400 px-3 py-2 hover:bg-pink-500 font-montserrat focus:outline-none focus:ring-2 focus:ring-pink-400 focus:bg-pink-400 focus:ring-offset-2 text-sm"
              >
                -
              </button>
            )}
      ...
      <div className=" flex items-center justify-center px-[85px] font-roboto py-3">
        {item.description}
      </div>
    </div>
  );
...
export default DetailedMenItem;
